...
export const property: PropertyConfig = {
  ...
  nearby: [
    ...
    { id: 'vatsa', type: 'beach', title: { el: 'Βάτσα', en: 'Vatsa Bay', es: 'Bahía de Vatsa', it: 'Baia di Vatsa' }, description: { el: 'Ήσυχος κόλπος για μια χαλαρή ημέρα δίπλα στη θάλασσα.', en: 'A quiet bay for a relaxed day by the sea.', es: 'Una bahía tranquila para pasar un día relajado junto al mar.', it: 'Una baia tranquilla per una giornata rilassante sul mare.' }, distance: { el: '16′ οδικώς · 8,9 χλμ.', en: '16 min by car · 8.9 km', es: '16 min en coche · 8,9 km', it: '16 min in auto · 8,9 km' } },
  ],
  faqs: [
