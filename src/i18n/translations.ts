...
export interface Translation {
  ...
  facts: Record<'guests' | 'bedrooms' | 'beds' | 'bathrooms' | 'area' | 'parking' | 'views' | 'airConditioning', string>
...
export const translations: Record<Language, Translation> = {
  el: {
    ...
    facts: { guests: 'Επισκέπτες', bedrooms: 'Υπνοδωμάτιο', beds: 'Κρεβάτια', bathrooms: 'Μπάνιο', area: 'Επιφάνεια', parking: 'Στάθμευση', views: 'Θέα', airConditioning: 'Κλιματισμός' },
    factValues: { yes: 'Ναι', gardenCity: 'Πόλη & κήπος', squareMetres: 'τ.μ.' },
    gallery: { kicker: 'Μια πρώτη αίσθηση', title: 'Φως, υφή και οικεία απλότητα', imageCount: '4 εικόνες', dialogLabel: 'Προβολή φωτογραφιών', provisional: 'Προσωρινή εικόνα' },
    ...
    amenities: { kicker: 'Ό,τι έχει επιβεβαιωθεί', title: 'Άνεση χωρίς περιττά', intro: 'Οι παρακάτω παροχές προέρχονται από τη δημόσια καταχώριση του καταλύματος. Επικοινωνήστε πριν από την άφιξη για ειδικά αιτήματα.', categories: { comfort: 'Άνεση', kitchen: 'Κουζίνα', home: 'Στο σπίτι', access: 'Πρόσβαση' } },
  ...
  en: {
    ...
    facts: { guests: 'Guests', bedrooms: 'Bedroom', beds: 'Beds', bathrooms: 'Bathroom', area: 'Area', parking: 'Parking', views: 'Views', airConditioning: 'Air conditioning' },
    factValues: { yes: 'Yes', gardenCity: 'Town & garden', squareMetres: 'm²' },
    gallery: { kicker: 'A first impression', title: 'Light, texture and familiar simplicity', imageCount: '4 images', dialogLabel: 'Photo viewer', provisional: 'Provisional image' },
    ...
    amenities: { kicker: 'Only what is confirmed', title: 'Comfort without excess', intro: 'The amenities below come from the property’s public listing. Please get in touch before arrival for any specific request.', categories: { comfort: 'Comfort', kitchen: 'Kitchen', home: 'At home', access: 'Access' } },
    location: { kicker: 'Your Paliki base', title: 'Lixouri, on Kefalonia’s western side', text: 'Meraki Home is close to Lixouri centre and port, with convenient access to daily essentials and the peninsula’s coast.', mapTitle: 'Map of the wider Lixouri area', approximate: 'The wider area is shown, not the exact entrance.', arrivalTitle: 'Getting here', arrivalText: 'From the airport, follow the road towards Lixouri or travel via Argostoli and the local ferry. Check routes and timetables before travelling.' },
  ...
  es: {
    ...
    facts: { guests: 'Huéspedes', bedrooms: 'Dormitorio', beds: 'Camas', bathrooms: 'Baño', area: 'Superficie', parking: 'Aparcamiento', views: 'Vistas', airConditioning: 'Climatización' },
    factValues: { yes: 'Sí', gardenCity: 'Ciudad y jardín', squareMetres: 'm²' },
    gallery: { kicker: 'Una primera impresión', title: 'Luz, textura y una sencillez familiar', imageCount: '4 imágenes', dialogLabel: 'Visor de fotografías', provisional: 'Imagen provisional' },
    ...
    amenities: { kicker: 'Solo lo que está confirmado', title: 'Comodidad sin excesos', intro: 'Estas comodidades proceden de la ficha pública del alojamiento. Consulta antes de llegar si tienes alguna necesidad concreta.', categories: { comfort: 'Confort', kitchen: 'Cocina', home: 'En casa', access: 'Acceso' } },
    location: { kicker: 'Tu base en Paliki', title: 'Lixouri, en el oeste de Cefalonia', text: 'Meraki Home está cerca del centro y del puerto de Lixouri, con acceso cómodo a lo cotidiano y a la costa de la península.', mapTitle: 'Mapa del área general de Lixouri', approximate: 'Se muestra la zona aproximada, no la entrada exacta.', arrivalTitle: 'Cómo llegar', arrivalText: 'Desde el aeropuerto, sigue la carretera hacia Lixouri o pasa por Argostoli y el ferry local. Comprueba rutas y horarios antes de viajar.' },
  ...
  it: {
    ...
    facts: { guests: 'Ospiti', bedrooms: 'Camera', beds: 'Letti', bathrooms: 'Bagno', area: 'Superficie', parking: 'Parcheggio', views: 'Vista', airConditioning: 'Climatizzazione' },
    factValues: { yes: 'Sì', gardenCity: 'Città e giardino', squareMetres: 'm²' },
    gallery: { kicker: 'Una prima impressione', title: 'Luce, materia e una semplicità familiare', imageCount: '4 immagini', dialogLabel: 'Visualizzatore foto', provisional: 'Immagine provvisoria' },
    ...
    amenities: { kicker: 'Solo ciò che è confermato', title: 'Comfort senza eccessi', intro: 'I servizi indicati provengono dalla scheda pubblica. Contattate l’host prima dell’arrivo per richieste specifiche.', categories: { comfort: 'Comfort', kitchen: 'Cucina', home: 'A casa', access: 'Accesso' } },
    location: { kicker: 'La vostra base a Paliki', title: 'Lixouri, sul versante occidentale di Cefalonia', text: 'Meraki Home è vicino al centro e al porto di Lixouri, con accesso comodo ai servizi quotidiani e alla costa della penisola.', mapTitle: 'Mappa dell’area generale di Lixouri', approximate: 'È mostrata la zona approssimativa, non l’ingresso esatto.', arrivalTitle: 'Come arrivare', arrivalText: 'Dall’aeroporto, seguite la strada per Lixouri oppure passate da Argostoli con il traghetto locale. Verificate itinerari e orari prima del viaggio.' },
