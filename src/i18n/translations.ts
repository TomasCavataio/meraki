...
export const translations: Record<Language, Translation> = {
  el: {
    ...
    gallery: { kicker: 'Μια πρώτη αίσθηση', title: 'Φως, υφή και οικεία απλότητα', imageCount: '6 εικόνες', dialogLabel: 'Προβολή φωτογραφιών', provisional: 'Προσωρινή εικόνα' },
  ...
  en: {
    ...
    gallery: { kicker: 'A first impression', title: 'Light, texture and familiar simplicity', imageCount: '6 images', dialogLabel: 'Photo viewer', provisional: 'Provisional image' },
  ...
  es: {
    ...
    gallery: { kicker: 'Una primera impresión', title: 'Luz, textura y una sencillez familiar', imageCount: '6 imágenes', dialogLabel: 'Visor de fotografías', provisional: 'Imagen provisional' },
  ...
  it: {
    ...
    gallery: { kicker: 'Una prima impressione', title: 'Luce, materia e una semplicità familiare', imageCount: '6 immagini', dialogLabel: 'Visualizzatore foto', provisional: 'Immagine provvisoria' },
